...
/**
  ...
  * @format: string with types of variables
...
/**
  ...
  * @args: va_list to get character from
  */
void _print_char(va_list *args)
{
	char ch;
...
/**
  ...
  * @args: va_list to get integer from
  */
void _print_integer(va_list *args)
{
	int i;
...
/**
  ...
  * @args: va_list to get float from
  */
void _print_float(va_list *args)
{
	float f;
